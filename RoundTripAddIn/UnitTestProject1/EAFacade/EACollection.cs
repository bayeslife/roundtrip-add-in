...
namespace UnitTestProject1.EAFacade
{
    ...
    public class EACollection : EA.Collection
    {
        ...
        public dynamic AddNew(string Name, string Type)
        {
            ...
            {
                if (Type.Equals(RoundTripAddIn.RoundTripAddInClass.EA_TYPE_PACKAGE))
            {
            ...
            else if (Type.Equals(RoundTripAddIn.RoundTripAddInClass.EA_TYPE_ASSOCIATION))
            {
            ...
            else if (Type.Equals(RoundTripAddIn.RoundTripAddInClass.EA_TYPE_ATTRIBUTE))
            {
            ...
            else if (Type.Equals(RoundTripAddIn.RoundTripAddInClass.EA_TYPE_CLASS) || Type.Equals(RoundTripAddIn.RoundTripAddInClass.EA_TYPE_OBJECT))
            {
            ...
            if (this.type.Equals(RoundTripAddIn.RoundTripAddInClass.EA_TYPE_ATTRIBUTE))
            {
                if (Type.Equals(RoundTripAddIn.RoundTripAddInClass.EA_TYPE_STRING))
                {
                    EAAttribute attr = new EAAttribute();
                    attr.Name = Name;
                    collection.Add(Name, attr);
