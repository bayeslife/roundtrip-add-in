...
namespace UnitTestProject1.EAFacade
{
    ...
    public class EAFactory
    {
        ...
        {
            Object o = EARepository.currentPackage.Elements.AddNew(name, "Object");
            EA.Element el = (EA.Element)o;          

            clientElement = (EAElement)el;
        ...
        {
            object a = this.clientElement.Attributes.AddNew(name, RoundTripAddInClass.EA_TYPE_ATTRIBUTE);
        ...
        public EAFactory addSupplier(EAElement element, string supplierRoleName, string cardinality, String stereotype)
        {
            ...
            object o = clientElement.Connectors.AddNew(element.Name, RoundTripAddInClass.EA_TYPE_ASSOCIATION);
        ...
        public EAFactory addSupplier(string name, string type, int classifierId, string targetStereotype, string[] states, string supplierRoleName, string cardinality,String stereotype)
        {
            ...
            //object o = clientElement.Connectors.AddNew(name, RoundTripAddInClass.EA_TYPE_ASSOCIATION);
            //EA.Connector connector = (EA.Connector)o;
