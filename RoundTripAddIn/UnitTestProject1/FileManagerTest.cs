...
namespace UnitTestProject1
{
    ...
    public class FileManagerTest
    {
        ...
        public void TestFileManager()
        {
            ...
            string p = fm.apiPath("api1", RoundTripAddInClass.RAML_0_8);
            Assert.AreEqual(@"c:\tmp\api1\src\main\api\api.raml", fm.apiPath("api1", RoundTripAddInClass.RAML_0_8));
            Assert.AreNotEqual(@"c:\tmp2\api1\src\main\api\api.raml", fm.apiPath("api1", RoundTripAddInClass.RAML_0_8));
