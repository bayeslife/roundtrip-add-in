...
namespace RoundTripAddIn
{
    ...
    public class SchemaManager
    {
        ...
        {
            if (RoundTripAddInClass.EA_TYPE_CURRENCY.ToLower().Equals(t.ToLower()))
            {
                return DataTypeManager.getCurrencyType();
            }
            if (RoundTripAddInClass.EA_TYPE_NUMBER.ToLower().Equals(t.ToLower()))
            {
                return DataTypeManager.getNumberType();
            }
            if (RoundTripAddInClass.EA_TYPE_DECIMAL.ToLower().Equals(t.ToLower()))
            {
                return DataTypeManager.getNumberType();
            }
            if (RoundTripAddInClass.EA_TYPE_FLOAT.ToLower().Equals(t.ToLower()))
            {
                return DataTypeManager.getNumberType();
            }
            if (RoundTripAddInClass.EA_TYPE_INT.ToLower().Equals(t.ToLower()))
            {
                return DataTypeManager.getIntegerType();
            }
            else if (RoundTripAddInClass.EA_TYPE_DATE.ToLower().Equals(t.ToLower()))
            {
                return DataTypeManager.getDateType();
            }
            else if (RoundTripAddInClass.EA_TYPE_DATETIME.ToLower().Equals(t.ToLower()))
            {
                return DataTypeManager.getDateTimeType();
            }
            else if (RoundTripAddInClass.EA_TYPE_BOOLEAN.ToLower().Equals(t.ToLower()))
            {
        ...
        {
            return (cardinality.Equals(RoundTripAddInClass.CARDINALITY_0_TO_MANY) || cardinality.Equals(RoundTripAddInClass.CARDINALITY_1_TO_MANY));           
        }
             ...
             */
        {
            ...
            foreach (EA.Element clazz in classes)
            {
                ...
                else
                {
                    ...
                    if (clazz.GetStereotypeList() != null && clazz.GetStereotypeList().Contains(RoundTripAddInClass.EA_STEREOTYPE_REQUEST))
                    {
                        container = schema;
                        root = clazz;
                    }
                ...
                {                    
                    ...
                    if (clazz.ElementID == con.ClientID)
                    {
                        ...
                        if (related != null)
                        {
                            ...
                            if (related.Stereotype.Contains(RoundTripAddInClass.EA_STEREOTYPE_DATAITEM))
                                                        ...
                                                        
                            {
                                ...
                                if (schemas.ContainsKey(related.Name))
                                {
                                    ...
                                    try
                                    {
                                        if (con.SupplierEnd.Cardinality.Equals(RoundTripAddInClass.CARDINALITY_0_TO_MANY) || con.SupplierEnd.Cardinality.Equals(RoundTripAddInClass.CARDINALITY_1_TO_MANY))
                                        {
                                        ...
                                        else if (con.Stereotype != null && con.Stereotype.Equals(RoundTripAddInClass.EA_STEREOTYPE_EMBEDDED))
                                        {
                                        ...
                                        if (con.SupplierEnd.Cardinality.Equals(RoundTripAddInClass.CARDINALITY_1_TO_MANY) || con.SupplierEnd.Cardinality.Equals(RoundTripAddInClass.CARDINALITY_ONE))
                                        {
        ...
        static void handleAttribute(JSchema schema,EA.Element clazz, EA.Attribute attr)
        {
            JSchema attributeSchema = SchemaManager.convertEATypeToJSchemaType(attr.Type);
            {
                ...
                {                            
                    if (da.Name.Equals(RoundTripAddInClass.EA_TAGGEDVALUE_PATTERN))
                    {
            ...
            else
            {
                ...
                if (attr.UpperBound.Equals(RoundTripAddInClass.CARDINALITY_ONE))
        ...
        static public string getDataItemType(EA.Element dataitem)
        {
            ...
            {
                String s = dataitem.GetStereotypeList().Replace(RoundTripAddInClass.EA_STEREOTYPE_DATAITEM, "");
                s = s.Replace(",", "");
                return s;
            }
            return null;                    
        ...
        static public string getDataItemExample(EA.Element dataitem)
        {
            ...
            {
                if (da.Name.Equals(RoundTripAddInClass.EA_TAGGEDVALUE_DEFAULT))
                {
                    if (da.Value != null && da.Value.Length > 0)
                    {
        ...
        static public void exportSchema(EA.Repository Repository, EA.Diagram diagram,DiagramCache diagramCache)
        {
            ...
            if (!diagram.Stereotype.Equals(RoundTripAddInClass.EA_STEREOTYPE_SCHEMADIAGRAM))
            {
        ...
        //{            
        //    if (!diagram.Stereotype.Equals(RoundTripAddInClass.EA_STEREOTYPE_CANONICALDIAGRAM))
        //    {
        ...
        static public EA.Package generateSample(EA.Repository Repository,DiagramCache diagramCache)
        {
            ...
            foreach (EA.Package p in apiPackage.Packages)
            {
                ...
                if (p.Name.Equals(RoundTripAddInClass.API_PACKAGE_SAMPLES))
                {
                    samplePackage = p;
                    break;
                }
            ...
            {
                MessageBox.Show("Create the '" + RoundTripAddInClass.API_PACKAGE_SAMPLES + "' package under the API");
                return null;
            }
            ...
            {                
                ...
                else if (diaclazz.GetStereotypeList().Contains(RoundTripAddInClass.EA_STEREOTYPE_REQUEST))
                {
                    clazz = diaclazz;                    
                    break;
                }
...

            {
                ...
                sample.Stereotype = RoundTripAddInClass.EA_STEREOTYPE_SAMPLE;                
                sample.Update();
            ...
            foreach (EA.Connector con in clazz.Connectors)
            {
                ...
                if (clazz.ElementID == con.ClientID)
                {
                    ...
                    if (related != null && diagramElementIds.Contains(related.ElementID))
                    {
                        ...
                        if (relatedClazz.Stereotype.Contains(RoundTripAddInClass.EA_STEREOTYPE_DATAITEM))
                        ...
                        else if (relatedClazz.Type.Equals("Class"))
                        {
                            ...
                            link.Direction = RoundTripAddInClass.DIRECTION_SOURCE_TARGET;
        ...
        static public void operateOnSample(EA.Repository Repository,System.Func<EA.Repository,EA.Element,bool> f)
        {
            ...
            {
                MessageBox.Show("The diagram must be stereotyped as:" + RoundTripAddInClass.EA_STEREOTYPE_SAMPLEDIAGRAM);
                return;
            }
        ...
        static Object syncDataItem(Object context, EA.Element clazz, EA.Connector connector, EA.Element attr)
        {
            ...
            if (sampleState.ContainsKey(attr.Name))
            {
                ...
                if (defVal != null) {
                    ...
                    attrTag.Name = RoundTripAddInClass.EA_TAGGEDVALUE_DEFAULT;
                    attrTag.Value = st;
                    attrTag.Update();
                }                                                
            }
        ...
        static public bool updateSampleFromClass(EA.Repository Repository,EA.Element sampleObject)
        {
            ...
            foreach (RunState rs in sampleState.Values)
            {
                ...
                if(attr!=null || attrnew!=null)
                {
                    ...
                    //if(!container.Type.Equals(RoundTripAddInClass.EA_TYPE_ENUMERATION))
                    //{
                    //    logger.log("Updating to property name:" + nm);
                    //    rs.key = nm;
                    //    updatedSampleState.Add(rs.key, rs);
    ...
    public class SchemaValidationManager
        ...
        public bool validateClass(EA.Element root)
        {
            ...
            if (root.Stereotype.Contains(RoundTripAddInClass.EA_STEREOTYPE_DATAITEM))
            {
        ...
        public bool validateRelationship(EA.Element client, EA.Connector connector, EA.Element supplierElement)
        {
            ...
            if (connector.SupplierEnd.Role.Length == 0 && (!supplierElement.Stereotype.Contains(RoundTripAddInClass.EA_STEREOTYPE_DATAITEM)))
            {
